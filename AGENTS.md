...
This project is indexed by GitNexus as **SIN-Hermes-Websearch-SerpAPI-Pool-Bundle** (140 symbols, 158 relationships, 1 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/SIN-Hermes-Websearch-SerpAPI-Pool-Bundle/context` | Codebase overview, check index freshness |
| `gitnexus://repo/SIN-Hermes-Websearch-SerpAPI-Pool-Bundle/clusters` | All functional areas |
| `gitnexus://repo/SIN-Hermes-Websearch-SerpAPI-Pool-Bundle/processes` | All execution flows |
| `gitnexus://repo/SIN-Hermes-Websearch-SerpAPI-Pool-Bundle/process/{name}` | Step-by-step execution trace |
